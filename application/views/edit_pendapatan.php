...
<div class="wrapper">
  ...
  <!-- Main content -->
       ...
       <div class="box-body">
        <?=$this->session->flashdata('pesan')?>
            ...
            <!-- form start -->
             ...
             <form class="form-horizontal" id="from" action="<?php echo site_url('pendapatan/update'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="hidden" name="idpendapatan"  id="idpendapatan" value="<?php echo  $u->idpendapatan?>">
                  <input type="text" class="form-control pull-right"  id="thn_pendapatan1" name="thn_pendapatan1" value="<?php echo  $u->thn_pendapatan1 ?>">
                </div>
        </div>  
    <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="thn_pendapatan2" name="thn_pendapatan2" value="<?php echo  $u->thn_pendapatan2 ?>">
                </div>
        </div>  
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="penjualanr_s1" "  class="form-control" value="<?php echo  $u->penjualanr_s1 ?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="penjualanr_s2"  class="form-control" value="<?php echo  $u->penjualanr_s2 ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Penjualan</label>
    <div class="col-lg-3">
            <input type="text" name="penjualan_s1"  id="penjualan_s1" class="form-control"  value="<?php echo  $u->penjualan_s1?>">
        </div>
     <div class="col-lg-3">
            <input type="text" name="penjualan_s2"  id="penjualan_s2" class="form-control"  value="<?php echo  $u->penjualan_s2?>">
        </div>
    </div>
    <div class="form-group">
   ...
   <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="bahan_baku1"  id="bahan_baku1" class="form-control" value="<?php echo  $u->bahan_baku1 ?>">
        </div>
         <div style="color: red;" id="invalid-bahan_baku1" class="error_msg"></div>
    <div class="col-lg-3">
            <input type="text" name="bahan_baku2"  id="bahan_baku2" class="form-control" value="<?php echo  $u->bahan_baku2 ?>">
        </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3">
    <input type="text" name="bahan_penolong1" id="bahan_penolong1" class="form-control" value="<?php echo  $u->bahan_penolong1 ?>">
     <div style="color: red;" id="invalid-bahan_penolong1" class="error_msg"></div>
    </div>
    <div class="col-lg-3">
    <input type="text" name="bahan_penolong2" id="bahan_penolong2" class="form-control" value="<?php echo  $u->bahan_penolong2 ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="hplain_lain1" id="hplain_lain1"  class="form-control" value="<?php echo  $u->hplain_lain1 ?>">
        </div>
           <div style="color: red;" id="invalid-hplain_lain1" class="error_msg"></div>
     <div class="col-lg-3">
            <input type="text" name="hplain_lain2"  id="hplain_lain2" class="form-control" value="<?php echo  $u->hplain_lain2 ?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="adminis_atk1" class="form-control" value="<?php echo  $u->laba_rugi1 ?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="adminis_atk2" class="form-control" value="<?php echo  $u->laba_rugi2 ?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Penjualan<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="biaya_penjualan1" class="form-control" value="<?php echo  $u->biaya_penjualan1 ?>">
        </div>
     <div class="col-lg-3">
            <input type="text" name="biaya_penjualan2" class="form-control" value="<?php echo  $u->biaya_penjualan2 ?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Telepon<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="telepon1" class="form-control" value="<?php echo  $u->telepon1 ?>">
        </div>
     <div class="col-lg-3">
            <input type="text" name="telepon2" class="form-control" value="<?php echo  $u->telepon2 ?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Air<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="air1" class="form-control" value="<?php echo  $u->air1?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="air2" class="form-control" value="<?php echo  $u->air2?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Listrik<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="listrik1" class="form-control" value="<?php echo  $u->listrik1?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="listrik2" class="form-control" value="<?php echo  $u->listrik2?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Penyusutan<font color="red">*</font></label>
    <div class="col-lg-3">
            <input type="text" name="biaya_penyusutan1" class="form-control" value="<?php echo  $u->biaya_penyusutan1?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="biaya_penyusutan2" class="form-control" value="<?php echo  $u->biaya_penyusutan2?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Gaji Pengusaha<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="biaya_gaji1" class="form-control" value="<?php echo  $u->biaya_gaji1?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="biaya_gaji2" class="form-control" value="<?php echo  $u->biaya_gaji2?>">
        </div>
    </div>
   <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Tenaga Kerja<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="Biaya_tenaga_kerja1" class="form-control" value="<?php echo  $u->Biaya_tenaga_kerja1?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="Biaya_tenaga_kerja2" class="form-control" value="<?php echo  $u->Biaya_tenaga_kerja2?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Kesehatan<font color="red">*</font></label>
     <div class="col-lg-3">
            <input type="text" name="biaya_kesehatan1" class="form-control" value="<?php echo  $u->biaya_kesehatan1?>">
        </div>
     <div class="col-lg-3">
            <input type="text" name="biaya_kesehatan2" class="form-control" value="<?php echo  $u->biaya_kesehatan2?>">
        </div>
     </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Transportasi<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="biaya_transportasi1" class="form-control" value="<?php echo  $u->biaya_transportasi1?>">
        </div>
     <div class="col-lg-3">
            <input type="text" name="biaya_transportasi2" class="form-control" value="<?php echo  $u->biaya_transportasi2?>"> 
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Pendidikan & Latihan</label>
        <div class="col-lg-3">
            <input type="text" name="biaya_pendidikan1" class="form-control" value="<?php echo  $u->biaya_pendidikan1?>">
        </div>
     <div class="col-lg-3">
            <input type="text" name="biaya_pendidikan2" class="form-control" value="<?php echo  $u->biaya_pendidikan2?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Promosi / Pemasaran<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="biaya_promosi1" class="form-control" value="<?php echo  $u->biaya_promosi1?>">
        </div>
     <div class="col-lg-3">
            <input type="text" name="biaya_promosi2" class="form-control" value="<?php echo  $u->biaya_promosi2?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Rumah Tangga<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="biaya_rumah_tangga1" class="form-control" value="<?php echo  $u->biaya_rumah_tangga1?>">
        </div>
      <div class="col-lg-3">
            <input type="text" name="biaya_rumah_tangga2" class="form-control" value="<?php echo  $u->biaya_rumah_tangga2?>">
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Anak Sekolah<font color="red">*</font></label>
        <div class="col-lg-3">
            <input type="text" name="biaya_sekolah1"  class="form-control" value="<?php echo  $u->biaya_sekolah1?>">
        </div>
    <div class="col-lg-3">
            <input type="text" name="biaya_sekolah2"  class="form-control" value="<?php echo  $u->biaya_sekolah2?>">
        </div>
    </div>
    </ol>
     <?php }  ?>
