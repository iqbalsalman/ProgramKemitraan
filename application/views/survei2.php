...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Jenis-Jenis barang modal</li></label>
        <div class="col-lg-5">
            <input type="text" name="jb_modal" class="form-control">
             <input type="hidden" name="idsurvei1" placeholder="Id Survei 1" id="idsurvei1" class="form-control" value="<?php echo $qry->idsurvei1?>" >
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Sumber Pembelian</li></label>
         <div class="col-lg-2">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kebutuhan stok barang/bln</li></label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kemampuan stok barang rata2</li></label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kemampuan penjualan rata2</li></label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Penyisihan laba mengangsur rata2</li></label>
        <div class="col-lg-3">
            <input type="text" name="p_laba_angsur" class="form-control">
        </div>
    </div><div class="form-group">
        <label class="col-lg-3 control-label"><li>Jenis-jenis bahan baku/bibit</li></label>
        <div class="col-lg-5">
            <input type="text" name="j_baku_bibit" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Sumber bahan baku/bibit</li></label>
        <div class="col-lg-3">
     ...
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Jenis2 bahan penolong</li></label>
        <div class="col-lg-3">
            <input type="text" name="j_bahan_penolong" class="form-control">
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Sumber bahan penolong</li></label>
        <div class="col-lg-4">
            <input type="text" name="s_bahan_penolong" class="form-control">
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kebutuhan bahan penolong</li></label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Hasil Produksi</li></label>
        <div class="col-lg-4">
            <input type="text" name="h_peroduksi" class="form-control">
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kemampuan Produksi rata2</li></label>
        <div class="col-lg-4">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kemampuan menyisihkan laba untuk mengangsur rata2</li></label>
        <div class="col-lg-3">
            <input type="text" name="k_angsur_rata" class="form-control">
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Pengajuan pinjaman anggota/bln</li></label>
        <div class="col-lg-4">
            <input type="text" name="p_pinjaman_anggota" class="form-control">
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kemampuan pemberi pinjaman</li></label>
        <div class="col-lg-4">
            <input type="text" name="k_pemberi_pinjaman" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Bunga</li></label>
        <div class="col-lg-2">
     ...
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Jangka waktu</li></label>
        <div class="col-lg-2">
     ...
     <div class="form-group">
        ...
        <div class="col-lg-3">
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Pelanggan tetap</li></label>
        <div class="col-lg-2">
        ...
        <div class="form-group">
        <label class="col-lg-3 control-label"><li>Cara Pembayaran</li></label>
        <div class="col-lg-2">
     ...
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Pengiriman produk</li></label>
        <div class="col-lg-2">
        ...
        <div class="form-group">
        <label class="col-lg-3 control-label"><li>Wilayah pemasaran</li></label>
        <div class="col-lg-3">
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kemitraan/ kerjasa,a dengan assosiasi, perusahaan, lain-lain</li></label>
         <div class="col-lg-3">
        ...
        <div class="col-lg-3">
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Data tenaga kerja</li></label>
       <div class="col-lg-3">
            <input type="text" name="jml_pegawai" class="form-control">
        </div>
        </div>
        <div class="form-group">
        <label class="col-lg-3 control-label"><li>Tingkat Keterampilan</li></label>
       <div class="col-lg-2">
        ...
        <div class="col-lg-2">
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Usia</li></label>
        <div class="col-lg-3">
        ...
        <div class="col-lg-3">
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Upah</li></label>
        <div class="col-lg-3">
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Cara memperoleh</li></label>
        <div class="col-lg-3">
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Jumlah Pengurus</li></label>
         <div class="col-lg-2">
            <input type="text" name="jml_pengurus" class="form-control">
        </div>
        </div>
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Jumlah anggota</li></label>
         <div class="col-lg-2">
        ...
        <label class="col-lg-3 control-label"><li>Keuangan</li></label>
         ...
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Pesaing</li></label>
         <div class="col-lg-3">
            <input type="text" name="pesaing" class="form-control">
        </div>
        </div>
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Langkah2 yang telah dilakukan sebelum pengajukan pinjaman ke Perum Peruri</li></label>
         <div class="col-lg-4">
