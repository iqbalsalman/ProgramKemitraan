        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Pegawai PK</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <center>
                                ...
                                <?php echo anchor('petugas/edit/'.$data->idpegawai,'<i class="fa fa-edit"></i>'); ?>
                                <?php echo anchor('petugas/hapus/'.$data->idpegawai,'<i class="fa fa-trash"></i>'); ?>     </center>       			</center>				
								</td>
					            </tr>
