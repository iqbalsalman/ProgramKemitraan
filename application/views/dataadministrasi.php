...
<!-- <center> <a href="http://localhost/pk/asset/img/<?=$cek->srs_tansi?>"><img width=32 height=32 src="http://localhost/pk/asset/img2/pdf.png"></a></center>
        ...
        <div class="col-lg-3">
          <img img width=32 height=32 src="http://localhost/pk/asset/img/<?=$data->upload_kk?>">
     ...
     <div class="form-group">
        ...
        <div class="col-lg-3">
            <a href="http://localhost/pk/asset/img/<?=$data->proposalk?>"><img width=32 height=32 src="http://localhost/pk/asset/img2/pdf.png"></a>
...
<div style="color: red;" id="invalid-kota_perusahaan" class="error_msg"></div>
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kecamatan<font color="red">*</font></li></label>
        <div class="col-lg-6">
        <?php echo $data->kecamatan_perusahaan?>
  ...
  <div class="form-group">
        <label class="col-lg-3 control-label"><li>Kelurahan/Desa<font color="red">*</font></li></label>
        <div class="col-lg-6">
 <?php echo $data->kelurahan_perusahaan?>
 <div style="color: red;" id="invalid-kelurahan_perusahaan" class="error_msg"></div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
             <a href="http://localhost/pk/asset/img/<?=$data->srs_tansi?>"><img width=32 height=32 src="http://localhost/pk/asset/img2/pdf.png"></a>
        </div>
  ...
  <div class="form-group">
       ...
       <?php echo $data->hutang_dagang1?>    
        </div>
    <div class="col-lg-3">
    <?php echo $data->hutang_dagang2?> 
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3">
    <?php echo $data->hlain1?> 
  
        </div>
    <div class="col-lg-3">
    <?php echo $data->hlain2?>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
        <?php echo $data->modal1?>
          
        </div>
    <div class="col-lg-3">
    <?php echo $data->modal2?>
   ...
   <div class="form-group">
        ...
        <div class="col-lg-3">
        <?php echo $data->laba_ditahan1?>
          
        </div>
    <div class="col-lg-3">
    <?php echo $data->laba_ditahan2?>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-2">
         <?php echo $data->prosentasi_bunga?>
  ...
  <div class="form-group">
        <label class="col-lg-3 control-label">Pokok Pinjaman</label>
       <div class="col-lg-4">
        <?php echo $data->pokok_pinjaman_dagang?>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-2">
          <?php echo $data->Besar_bunga_dagang?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Prosentase Bunga</label>
       <div class="col-lg-2">
       <?php echo $data->prosentase_bunga_dagang?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Sisa Pinjaman</label>
       <div class="col-lg-4">
        <?php echo $data->sisa_pinjaman_dagang?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Sisa kali angsuran</label>
       <div class="col-lg-2">
        <?php echo $data->sisa_angsuran_dagang?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Jumlah angsuran / bln</label>
       <div class="col-lg-4">
         <?php echo $data->jml_angsuran_dagang?>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label">Pokok Pinjaman</label>
       <div class="col-lg-4">
        <?php echo $data->pokok_pinjaman_bumn?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label"></label>
       <div class="col-lg-2">
       <?php echo $data->besar_bunga_bumn?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Prosentase Bunga</label>
       <div class="col-lg-2">
        <?php echo $data->prosentase_bunga_bumn?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa Pinjaman</label>
       <div class="col-lg-4">
        <?php echo $data->sisa_pinjaman_bumn?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Sisa kali angsuran<</label>
       <div class="col-lg-2">
       <?php echo $data->sisa_angsuran_bumn?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Jumlah angsuran / bln</label>
       <div class="col-lg-4">
       <?php echo $data->jml_angsuran_bumn?>
        </div>
    </div>
  ...
  <div class="form-group">
        <label class="col-lg-3 control-label">Pokok Pinjaman</label>
       <div class="col-lg-4">
       <?php echo $data->pokok_pinjaman_badan?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Besar Bunga</label>
       <div class="col-lg-2">
        <?php echo $data->besar_bunga_badan?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Prosentase Bunga</label>
       <div class="col-lg-2">
        <?php echo $data->prosentase_bunga_badan?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Sisa Pinjama</label>
       <div class="col-lg-4">
        <?php echo $data->sisa_pinjaman_badan?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Sisa kali angsuran</label>
       <div class="col-lg-2">
       <?php echo $data->sisa_angsuran_badan?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Jumlah angsuran / bln</label>
       <div class="col-lg-4">
        <?php echo $data->jml_angsuran_badan?>
        </div>
    </div>
    </ol>
</form>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
         <?php echo $data->penjualanr_s1?>
        </div>
    <div class="col-lg-3">
    <?php echo $data->penjualanr_s2?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Penjualan</label>
    <div class="col-lg-3">
    <?php echo $data->penjualan_s1?>
    
        </div>
     <div class="col-lg-3">
      <?php echo $data->penjualan_s2?>
        </div>
    </div>
    <div class="form-group">
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
          <?php echo $data->adminis_atk1?>
        </div>
    <div class="col-lg-3">
    <?php echo $data->adminis_atk2?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Penjualan<font color="red">*</font></label>
        <div class="col-lg-3">
          <?php echo $data->biaya_penjualan1?>
        </div>
     <div class="col-lg-3">
     <?php echo $data->biaya_penjualan2?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label">Biaya Telepon<font color="red">*</font></label>
        <div class="col-lg-3">
         <?php echo $data->telepon1?>
        </div>
     <div class="col-lg-3">
      <?php echo $data->telepon2?>
        </div>
    </div>
  <div class="form-group">
  ...
  <div class="form-group">
        <label class="col-lg-3 control-label"><li>omset / bln</li></label>
        <div class="col-lg-2">
        <?php echo $data->omset_non_produksi?>
        </div>
    </div>
    </ol>
     <div class="form-group">
  ...
  <div class="form-group">
       ...
       <div class="col-lg-3">
        <?php echo $data->produksi1?>
        </div>
    <div class="col-lg-3">
    <?php echo $data->produksi2?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label"><li>Omset rata-rata / bulan</li></label>
       <div class="col-lg-3">
        <?php echo $data->omset_rata1?>
           
        </div>
    <div class="col-lg-3">
      <?php echo $data->omset_rata2?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label"><li>Tabungan / bulan</li></label>
       <div class="col-lg-3">
       <?php echo $data->tabungan1?>
            
        </div>
    <div class="col-lg-3">
           <?php echo $data->tabungan2?>
        </div>
    </div>
    </ol>
    <div class="form-group">
  ...
  <div class="form-group">
       ...
       <div class="col-lg-4">
       <?php echo $data->jml_bantuan_pinajaman?>
        </div>
    </div>
  <div class="form-group">
        <label class="col-lg-3 control-label"><li>Modal Kerja</li></label>
       <div class="col-lg-4">
        <?php echo $data->modal_kerja?>
  ...
  <div class="form-group">
       ...
       <div class="col-lg-4">
        <?php echo $data->kasanggupan_angsuran?>
        </div>
    </div>
    </ol>
    </ol>
