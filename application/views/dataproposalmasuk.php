        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Proposal Masuk</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th style='text-align:center;'>Action</center></th>
            ...
            foreach ($query as $data) {
                ...
                ?>
                      ...
                      <td> <center>
                <?php echo anchor('proposal_masuk/doprint/'.$data->idproposal,'<i class="fa fa-print" aria-hidden="true"></i>'); ?>
                                          </center> </td>
                      </tr>
