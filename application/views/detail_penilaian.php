        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Parameter Penilaian administrasi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <?=$this->session->flashdata('pesan')?>
              <table id="example2" class="table table-bordered table-hover">
                ...
                ?> 
                      <tr>
                      <td><center><?php echo $nomer?></td>
                      <td><?php if($cek->upload_ktp != '') echo '<img width=32 height=32 src="http://localhost/pk/asset/img2/ceklis.png"> '; else echo '<img width=32 height=32 src="http://localhost/pk/asset/img2/strips.png">'; ?></center></td>
                      ...
                      <td><center><?php if($cek->srs_tansi != '') echo '<img width=32 height=32 src="http://localhost/pk/asset/img2/ceklis.png">'; else echo '<img width=32 height=32 src="http://localhost/pk/asset/img2/strips.png">'; ?></center></td>
                       ...
                       <td><center><?php echo $cek->status?></td>
                      </tr>
