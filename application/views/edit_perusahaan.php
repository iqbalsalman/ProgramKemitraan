...
<div class="wrapper">
  ...
  <!-- Main content -->
       ...
       <div class="box-body">
        <?=$this->session->flashdata('pesan')?>
            ...
            <!-- form start -->
             ...
             <form class="form-horizontal"  id="form"  action="<?php echo site_url('perusahaan/update'); ?>" method="post" enctype="multipart/form-data">
             <?php foreach($query as $u){ ?>
             <ol type="1">
         <div class="form-group">
        <label class="col-lg-3 control-label"><li>Nama Perusahaan/Koperasi<font color="red">*</font></li></label>
        <div class="col-lg-5">
           <input type="hidden" name="idperusahaan" placeholder="No resi" class="form-control"  value="<?php echo $u->idperusahaan ?>"  >
            <input type="text" name="nama_perusahaan" placeholder="Nama Perusahaan/Koperasi" id="nama_perusahaan" class="form-control"  value="<?php echo $u->nama_perusahaan ?>" >
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4">
            <input type="text" name="tpemilik_koprasi" placeholder="Nama Pemilik/Ketua Koperasi" class="form-control" id="tpemilik_koprasi" value="<?php echo $u->tpemilik_koprasi ?>">
        </div>
    ...
    <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="p_binaan_pk" name="p_binaan_pk" value="<?php echo $u->p_binaan_pk ?>" >
                </div>
                <div style="color: red;" id="invalid-p_binaan_pk" class="error_msg"></div>
        </div>
     <div class="col-lg-2">
            <input type="text" name="kd_binaan" placeholder="Kode Binaan No" id="kd_binaan" class="form-control" value="<?php echo $u->kd_binaan ?>">
        </div>
   ...
   <div class="form-group">
        ...
        <div class="col-lg-3">
            <select name="bidang_usaha" class="form-control" id="bidang_usaha" value="<?php echo $u->bidang_usaha ?>">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3">
    <input type="text" name="jenis_usaha" placeholder="Jenis Usaha" class="form-control" id="jenis_usaha" value="<?php echo $u->jenis_usaha ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-6">
            <input type="text" name="alamat_perusahaan"  class="form-control" id="alamat_perusahaan" value="<?php echo $u->alamat_perusahaan ?>">
        </div>
...
<option value=''>--pilih--</option>
 ...
 <div style="color: red;" id="invalid-kelurahan_perusahaan" class="error_msg"></div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-2">
            <input type="text" name="kode_pos_p" class="form-control" id="kode_pos_p" value="<?php echo $u->kode_pos_p?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="notlp_perusahaan" class="form-control" id="notlp_perusahaan" value="<?php echo $u->notlp_perusahaan?>">
        </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3">
            <input type="file" name="upload_struk_organisasi" class="form-control" id="upload_struk_organisasi" value="<?php echo $u->upload_struk_organisasi?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-2">
            <select name="stt_usaha" class="form-control" id="stt_usaha" value="<?php echo $u->stt_usaha?>">
     ...
     <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="thn_sttusaha" name="thn_sttusaha" value="<?php echo $u->thn_sttusaha?>">
                </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-2">
            <input type="text" name="siup" id="siup" class="form-control" placeholder="SIUP Nomer" value="<?php echo $u->siup ?>">
    </div>
     <div style="color: red;" id="invalid-siup" class="error_msg"></div>
      <div class="col-lg-2">
            <input type="text" name="tdp" id="tdp" class="form-control" placeholder="TDP Nomer" value="<?php echo $u->tdp ?>">
    </div>
     <div style="color: red;" id="invalid-tdp" class="error_msg"></div>
      <div class="col-lg-2">
            <input type="text" name="ho" id="ho" class="form-control" placeholder="HO Nomer" value="<?php echo $u->ho ?>">
    </div>
     <div style="color: red;" id="invalid-ho" class="error_msg"></div>
      <div class="col-lg-2">
            <input type="text" name="situ" id="situ" class="form-control" placeholder="SITU Nomer" value="<?php echo $u->situ ?>">
    </div>
   ...
   <div class="form-group">
    <label class="col-lg-3 control-label"></label>
     <div class="col-lg-2">
            <input type="text" name="sku" id= "sku" class="form-control" placeholder="SKU Nomer" value="<?php echo $u->sku ?>">
    </div>
     <div style="color: red;" id="invalid-sku" class="error_msg"></div>
    <div class="col-lg-2">
            <input type="text" name="bdn_hukum" id="bdn_hukum" class="form-control" placeholder="BH Nomor" value="<?php echo $u->bdn_hukum ?>">
    </div>
   ...
   <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="npwp" id="npwp" class="form-control" placeholder="NPWP" value="<?php echo $u->npwp?>">
        </div>
     ...
     <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="nmpgang_hak" id="nmpgang_hak" class="form-control" placeholder="Nama Pemegang Hak" value="<?php echo $u->nmpgang_hak?>">
        </div>
         <div style="color: red;" id="invalid-nmpgang_hak" class="error_msg"></div>
        <div class="col-lg-3">
            <input type="text" name="lokasi_tanah" id="lokasi_tanah" class="form-control" placeholder="Desa/Kel" value="<?php echo $u->lokasi_tanah?>">
        </div>
         <div style="color: red;" id="invalid-lokasi_tanah" class="error_msg"></div>
         <div class="col-lg-2">
            <input type="text" name="no_tanah" id="no_tanah" class="form-control" placeholder="No" value="<?php echo $u->no_tanah?>">
        </div>
    ...
    <label class="col-lg-3 control-label"></label>
      <div class="col-lg-2">
            <input type="text" name="luas_tanah" id="luas_tanah" class="form-control" placeholder="Luas Tanah" value="<?php echo $u->luas_tanah?>">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="file" name="srs_tansi" id="srs_tansi" class="form-control" value="<?php echo $u->srs_tansi ?>">
        </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-2">
        <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="berdiri_tahun" name="berdiri_tahun" value="<?php echo $u->berdiri_tahun?>">
          </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="jml_karyawan" id="jml_karyawan" class="form-control" value="<?php echo $u->jml_karyawan?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="jml_teng_ahli" id="jml_teng_ahli" class="form-control" value="<?php echo $u->jml_teng_ahli?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="jml_pengurus" id="jml_pengurus" class="form-control" value="<?php echo $u->jml_pengurus?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="rekening_koran" id="rekening_koran" class="form-control" value="<?php echo $u->rekening_koran?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="nama_bank_koran" id="nama_bank_koran" placeholder="Nama Bank" class="form-control" value="<?php echo $u->nama_bank_koran?>">
        </div>
  ...
  <div class="form-group">
       ...
       <div class="col-lg-5">
            <input type="text" name="alamat_bank_koran" id="alamat_bank_koran" class="form-control" value="<?php echo $u->alamat_bank_koran?>">
        </div>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="nomer_buku_tabungan" id="nomer_buku_tabungan" class="form-control" value="<?php echo $u->nomer_buku_tabungan?>">
        </div>
  ...
  <div class="form-group">
        <label class="col-lg-3 control-label"><dd>- Nama Bank</dd></label>
        <div class="col-lg-4">
            <input type="text" name="nama_bank" id="nama_bank" placeholder="Nama Bank" class="form-control"  value="<?php echo $u->nama_bank?>">
        </div>
  ...
  <div class="form-group">
        <label class="col-lg-3 control-label"><dd>- Alamat Bank</dd></label>
       <div class="col-lg-5">
            <input type="text" name="alamat_tabungan" id="alamat_tabungan" class="form-control" value="<?php echo $u->alamat_tabungan?>">
        </div>
  ...
  <div class="form-group">
       ...
       <div class="col-lg-5">
            <input type="text" name="bantuan_l" id="bantuan_l" class="form-control" value="<?php echo $u->bantuan_l?>">
        </div>
