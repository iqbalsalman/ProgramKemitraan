...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <!-- form start -->
             <form class="form-horizontal" action="<?php echo site_url('penilaian/surattolak'); ?>" method="post" enctype="multipart/form-data">
             <?php foreach ($query as $data) { ?>
        
    <div class="form-group">
        <label class="col-lg-3 control-label" >Nama Lengkap</label>
        <div class="col-lg-4">
            <input type="text" name="nama" placeholder="Nama Lengkap" class="form-control" value="<?php echo $data->nm_pemilik?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4">
            <input type="text" name="alamat" placeholder="Alamat" class="form-control" value="<?php echo $data->alamat_perusahaan?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="tanggal" name="tanggal" value="<?php echo $data->tgl_evaluasi ?>">
                </div>
     ...
     <div class="form-group">
        <label class="col-lg-3 control-label">No surat<font color="red">*</font></label>
        <div class="col-lg-4">
            <input type="text" readonly name="nopenolakn" value="<?=$kodeunik?>" class="form-control" id="nopenolakn"> 
        </div>
