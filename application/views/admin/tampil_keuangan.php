              ...
              <table id="example2" class="table table-bordered table-hover">
	                ...
	                <?php
						...
						foreach ($keuangan as $data) {
					     ...
					     <td><?php echo $data->thn1,' <br/> ', ' ', $data->thn2 ?></td>
								<td><?php echo $data->kas1,' <br/> ', ' ', $data->kas2 ?></td>
								<td></td>
								<td></td>
								<td></td>
                <td></td>
								<td><?php echo anchor('keuangan/edit/'.$data->idkeuangan,'Edit'); ?>
                                <?php echo anchor('keuangan/hapus/'.$data->idkeuangan,'Hapus'); ?>  </td>
