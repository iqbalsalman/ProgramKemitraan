              ...
              <table id="example2" class="table table-bordered table-hover">
	                ...
	                <?php
						...
						foreach ($query as $data) {
					     ...
					     <td><?php echo $data->thn_pendapatan1 ?></td>
								<td><?php echo $data->thn_pendapatan2 ?></td>
								<td><?php echo $data->penjualan_ro1 ?></td>
								<td><?php echo $data->penjualan_ro2 ?></td>
								<td></td>
                <td></td>
								<td> <?php echo anchor('pendapatan/edit/'.$data->idpendapatan,'Edit'); ?>
                                <?php echo anchor('pendapatan/hapus/'.$data->idpendapatan,'Hapus'); ?>  </td>
