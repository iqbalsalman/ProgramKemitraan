              ...
              <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th>Nama Pemilik Koprasi</th>
                        <th>Pernah menjadi mitra binaan PKBL Perum Peruri</th>
                        <th>Bidang Usaha</th>
                        <th>Jenis Usaha</th>
	                ...
	                <?php
						$nomer=0;
					        ...
					        foreach ($query as $data) {
								...
								<td></td>
								<td>
                                <?php echo anchor('perusahaan/edit/'.$data->idperusahaan,'Edit'); ?>
                                <?php echo anchor('perusahaan/hapus/'.$data->idperusahaan,'Hapus'); ?> 
								</td>
					            </tr>
