        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daa Calon Akun Mitra Binaan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
foreach ($query as $data) {
    ...
    ?>
                      ...
                      <td><?php echo $data->tlpon ?></td>
                      <td><?php echo $data->dinas_daerah ?></td>
								      <td><?php echo $data->jenis_akses ?></td>
								<td>
                <center>

                                <?php echo anchor('akun/edit/' . $data->id, '<i class="fa fa-edit"></i>'); ?>
                                <?php echo anchor('akun/hapus/' . $data->id, '<i class="fa fa-trash"></i>'); ?>     </center>       			</center>
								</td>
					            </tr>
