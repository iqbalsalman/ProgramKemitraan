...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <form class="form-horizontal" id="form" action="<?php echo site_url('penilaian/update_p2'); ?>" method="post" enctype="multipart/form-data" >
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label">Catatan Khusus<font color="red">*</font></label>
        <div class="col-lg-6">
