            ...
            <div class="modal-body form">
                ...
                <input name="nama" placeholder="Nama Lengkap" class="form-control" type="text" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nik" placeholder="No KTP" class="form-control" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Dana yang disetujui</label>
                            <div class="col-md-9">
                                <input name="dob" placeholder="Dana yang disetujui" class="form-control" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
