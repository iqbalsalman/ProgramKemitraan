        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Penjadwalan PKBL Perum Peruri</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
	                ...
	                <?php
                      ...
                      <td><center><?php echo $data->np_pegawai?></center></td>
					            <td><center><?php echo $data->nama_pegawai?></center></td>
                      <td><center><?php echo $data->s_jabatan?></center></td>
                      <td><center><?php if( $data->status !="Telah Terjadwalkan"){
              
                      echo anchor('penjadwalan/penjadwalan/'.$data->idpegawai,'<input type="button" class="btn btn-success" value="Scheduling"');
	                }else{
                    echo anchor('penjadwalan/penjadwalan/'.$data->idpegawai,'<input type="button" class="btn btn-success" disabled value="Scheduling"');
                  }	
              ?></center>
					     </td> 
