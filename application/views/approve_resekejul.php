        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Approve Reschedule PKBL</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
	                ...
	                <?php
                      ...
                      echo anchor('penjadwalan/Approve_resekejul/'.$data->idpegawai,'<input type="button" class="btn btn-success" disabled value="Detail"');
	                }else{
                    echo anchor('penjadwalan/Approve_resekejul/'.$data->idpegawai,'<input type="button" class="btn btn-success"   value="Detail"');
                  }	
              ?></center>
					     </td> 
