	                ...
	                <?php
                      ...
                      <td><?php echo $data->status?></td>
                       <td><?php echo $data->catatan?></td>
								<td>
                <center>
                        <!-- <?php echo anchor('penilaian/doprint/'.$data->idevaluasi,'<i class="fa fa-print" aria-hidden="true"></i>'); ?>
                         -->
                        <?php echo anchor('penilaian/penolakansurat/','<input type="button" class="btn btn-success" value="Surat">'); ?>           			
                         		</center>				
								</td>
					            </tr>
