        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Save Approve Reschedule</h3>
            </div>
       <div class="box-body">
        <?=$this->session->flashdata('pesan')?>
         ...
         ?>
         <form class="form-horizontal" action="<?php echo site_url('penjadwalan/updatepegawai'); ?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
        <label class="col-lg-3 control-label">NIP</label>
        <div class="col-lg-2">
            <input type="text" name="np_pegawai" class="form-control" placeholder="NIP" value="<?php echo $data->np_pegawai ?>">
        </div>
  </div>
         <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="nama_pegawai" placeholder="Nama Lengkap" class="form-control" value="<?php echo $data->nama_pegawai ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Nomer Telepon</label>
        <div class="col-lg-3">
            <input type="text" name="nohp_pegawai" class="form-control" placeholder="Nomer Telepon" value="<?php echo $data->nohp_pegawai ?>">
        </div>
    </div>
     <div class="form-group">
     ...
     <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="s_jabatan" class="form-control" placeholder="Jabatan" value="<?php echo $data->s_jabatan ?>">
        </div>
    </div>
