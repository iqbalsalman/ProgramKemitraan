      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."index.php/penjadwalan/dpenjadwalan"; ?>"><i class="fa fa-circle-o"></i>Penjadwalan Survei</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Penjadwalan Surveyor</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th><center>Tanggal Penugasan</center></th>
                        <th><center>Masa Berakhir Tugas</center></th>
                ...
                <td><center><?php echo $data->jmlhari?></center></td>
                <td><center><?php echo $data->nm_pemilik?></center></td>
								<td><center>
                                <!-- <?php echo anchor('penjadwalan/edit/'.$data->idpenjadwalan,'<i class="fa fa-edit"></i>'); ?>
                                <?php echo anchor('penjadwalan/hapus/'.$data->idpenjadwalan,'<i class="fa fa-trash"></i>');?> -->
                                <?php if($data->status_j != "Telah Terjadwalkan"){
                                echo anchor('penjadwalan/resekejuljadwal/'.$data->idpenjadwalan,'<input type="button" class="btn btn-success" disabled  value="Reschedule
"');

                             }else{
                              echo anchor('penjadwalan/resekejuljadwal/'.$data->idpenjadwalan,'<input type="button" class="btn btn-success" value="Reschedule"');
                             }
                                ?>
                                </center>
