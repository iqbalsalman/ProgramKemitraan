...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <form class="form-horizontal" id="form" action="<?php echo site_url('penjadwalan/insert'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-lg-4">
            <input type="text" name="nip" id="nip" placeholder="Nip " class="form-control" value="<?php echo $u->np_pegawai?>" >
	...
	<div class="form-group">
        ...
        <div class="col-lg-4">
            <input type="text" name="nama_surveyor" id="nama_surveyor" placeholder="Nama Lengkap " class="form-control" value="<?php echo $u->nama_pegawai?>" >
        </div>
         <div style="color: red;" id="invalid-nama_surveyor" class="error_msg"></div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">UKM</label>
        <div class="col-lg-2">
            <select name="idakun" class="form-control" id="idakun">  
<?php  foreach ($query as $prov) {
echo "<option value='$prov->idevaluasi'>$prov->nm_pemilik</option>";
    ...
    <div class="form-group">
		...
		<div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="tgl_tugas1" name="tgl_tugas1" >
                </div>
		...
		<div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="tgl_tugas2" name="tgl_tugas2" >
                </div>
