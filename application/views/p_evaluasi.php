  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <form class="form-horizontal" id="form" action="<?php echo site_url('penilaian/update'); ?>" method="post" enctype="multipart/form-data" >
          <?php foreach ($qry as $u) {  ?>
            <div class="form-group">
        <label class="col-lg-3 control-label">idpenilaian<font color="red">*</font></label>
        <div class="col-lg-6">
            <input type="text" name="idpenilaian"  class="form-control" id="idpenilaian" value="<?php echo $u->idpenilaian?>" >
            <div style="color: red;" id="invalid-idpenilaian" class="error_msg"></div>
        </div>
    </div>
         <div class="form-group">
        ...
        <div class="col-lg-2">
            <select name="status" class="form-control" id="status">
                ...
                <option value="Layak Survei">Layak Survei</option>
                <option value="Tidak Layak Survei">Tidak Layak Survei</option>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
        <label class="col-lg-3 control-label">idkegiatanusaha<font color="red">*</font></label>
        <div class="col-lg-6">
            <input type="text" name="idkegiatanusaha"  class="form-control" id="idkegiatanusaha" value="<?php echo $u->idkegiatanusaha?>" >
            <input type="hidden" name="idevaluasi" class="form-control" value="<?php echo $u->idkegiatanusaha?>">
            <div style="color: red;" id="invalid-idkegiatanusaha" class="error_msg"></div>
        </div>
    </div>
    <?php } ?>
