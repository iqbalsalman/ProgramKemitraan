    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."index.php/penilaian/penolakan"; ?>"><i class="fa fa-circle-o"></i>Surat Penolakan proposal</a></li>

          </ul> 
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."index.php/penilaian/tampilsurat"; ?>"><i class="fa fa-circle-o"></i>Data Surat Penolakan proposal</a></li>
              ...
              <table id="example2" class="table table-bordered table-hover">
	                ...
	                <?php
						...
						foreach ($penjadwalan as $data) {
					      ...
					      <td><?php echo $data->nama_surveyor?></td>
								<td><?php echo $data->tgl_tugas1?></td>
								<td><?php echo $data->tgl_tugas2?></td>
                <td><?php echo $data->jmlhari?></td>
								<td>
                <center>
                                <?php echo anchor('penjadwalan/doprint/'.$data->idpenjadwalan,'<i class="fa fa-print" aria-hidden="true"></i>'); ?>			
                                </center>						
								</td>
					            </tr>
