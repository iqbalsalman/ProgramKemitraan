...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        ...
        <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="thn1" name="thn1" >
                </div>
        </div>  
        ...
        <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="thn2" name="thn2" >
                </div>
        </div>  
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="kas1" placeholder="Kas" id="kas1" class="form-control"  onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-kas1" class="error_msg"></div>
        <div class="col-lg-3">
            <input type="text" name="kas2" placeholder="Kas" id="kas2" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="bank1"  id="bank1" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-bank1" class="error_msg"></div>
         <div class="col-lg-3">
            <input type="text" name="bank2"  id="bank2" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
     ...
     <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="piutang1"  id="piutang1" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-piutang1" class="error_msg"></div>
        <div class="col-lg-3">
            <input type="text" name="piutang2"  id="piutang2" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
        <input type="text" name="pes_barang1"  class="form-control" id="pes_barang1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    <div style="color: red;" id="invalid-pes_barang1" class="error_msg"></div>
        <div class="col-lg-3">
        <input type="text" name="pes_barang2" class="form-control" id="pes_barang2" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="per_produksi1"  class="form-control" id="per_produksi1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-per_produksi1" class="error_msg"></div>
         <div class="col-lg-3">
            <input type="text" name="per_produksi2"  class="form-control" id="per_produksi2" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="per_kantor1" class="form-control" id="per_kantor1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-per_kantor1" class="error_msg"></div>
        <div class="col-lg-3">
            <input type="text" name="per_kantor2" class="form-control" id="per_kantor2" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="bangunan1" class="form-control" id="bangunan1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-bangunan1" class="error_msg"></div>
        <div class="col-lg-3">
            <input type="text" name="bangunan2" class="form-control" id="num" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="tanah1" class="form-control" id="tanah1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-tanah1" class="error_msg"></div>
         <div class="col-lg-3">
            <input type="text" name="tanah2" class="form-control" id="tanah2" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="lain1" class="form-control" id="lain1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
        <div style="color: red;" id="invalid-lain1" class="error_msg"></div>
         <div class="col-lg-3">
            <input type="text" name="lain2" class="form-control" id="lain2" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="htnb1" class="form-control">
        </div>
        <div class="col-lg-3">
            <input type="text" name="htnb2" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Hutang Dagang</li></label>
        <div class="col-lg-3">
            <input type="text" name="hutang_dagang1" class="form-control">
        </div>
        <div class="col-lg-3">
            <input type="text" name="hutang_dagang2" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Hutang lain-lain</li></label>
        <div class="col-lg-3">
            <input type="text" name="hlain1" class="form-control">
        </div>
        <div class="col-lg-3">
            <input type="text" name="hlain2" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label"><li>Modal</li></label>
        <div class="col-lg-3">
            <input type="text" name="modal1" class="form-control">
        </div>
        <div class="col-lg-3">
            <input type="text" name="modal2" class="form-control">
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label"><li>Laba ditahan</li></label>
        <div class="col-lg-3">
            <input type="text" name="laba_ditahan1" class="form-control">
        </div>
        <div class="col-lg-3">
            <input type="text" name="laba_ditahan2" class="form-control">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4">
            <input type="text" name="pok_pinjaman" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Besar Bunga</label>
        <div class="col-lg-2">
            <input type="text" name="besar_Bunga" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Prosentasi Bunga</label>
        <div class="col-lg-2">
            <input type="text" name="prosentasi_bunga" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa Pinjaman</label>
        <div class="col-lg-4">
            <input type="text" name="sisa_pinjaman" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa kali ansur</label>
        <div class="col-lg-2">
            <input type="text" name="sisa_kali_ansur"  class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Jumlah angsuran / bln</label>
       <div class="col-lg-4">
            <input type="text" name="jml_angsuran" class="form-control">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <input type="text" name="nama_perusahaan_d" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Pokok Pinjaman</label>
       <div class="col-lg-4">
            <input type="text" name="pokok_pinjaman_dagang" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Besar Bungan</label>
        <div class="col-lg-2">
            <input type="text" name="Besar_bunga_dagang" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Prosentase Bunga</label>
       <div class="col-lg-2">
            <input type="text" name="prosentase_bunga_dagang" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa Pinjaman</label>
       <div class="col-lg-4">
            <input type="text" name="sisa_pinjaman_dagang" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa kali angsuran</label>
       <div class="col-lg-2">
            <input type="text" name="sisa_angsuran_dagang" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Jumlah angsuran / bln</label>
       <div class="col-lg-4">
            <input type="text" name="jml_angsuran_dagang" class="form-control">
        </div>
    </div>
     <div class="form-group">
    ...
    <div class="form-group">
       ...
       <div class="col-lg-5">
            <input type="text" name="nama_bumn" class="form-control">
        </div>
    </div>
        <div class="form-group">
        <label class="col-lg-3 control-label">Pokok Pinjaman</label>
       <div class="col-lg-4">
            <input type="text" name="pokok_pinjaman_bumn" class="form-control">
        </div>
    </div>
        <div class="form-group">
        <label class="col-lg-3 control-label"></label>
       <div class="col-lg-2">
            <input type="text" name="besar_bunga_bumn" class="form-control">
        </div>
    </div>
        <div class="form-group">
        <label class="col-lg-3 control-label">Prosentase Bunga</label>
       <div class="col-lg-2">
            <input type="text" name="prosentase_bunga_bumn" class="form-control">
        </div>
    </div>
        <div class="form-group">
        <label class="col-lg-3 control-label">Sisa Pinjaman</label>
       <div class="col-lg-4">
            <input type="text" name="sisa_pinjaman_bumn" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa kali angsuran<</label>
       <div class="col-lg-2">
            <input type="text" name="sisa_angsuran_bumn" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Jumlah angsuran / bln</label>
       <div class="col-lg-4">
            <input type="text" name="jml_angsuran_bumn" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group">
       ...
       <div class="col-lg-5">
            <input type="text" name="nama_badan" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Pokok Pinjaman</label>
       <div class="col-lg-4">
            <input type="text" name="pokok_pinjaman_badan" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Besar Bunga</label>
       <div class="col-lg-2">
            <input type="text" name="besar_bunga_badan" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Prosentase Bunga</label>
       <div class="col-lg-2">
            <input type="text" name="prosentase_bunga_badan" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa Pinjama</label>
       <div class="col-lg-4">
            <input type="text" name="sisa_pinjaman_badan" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Sisa kali angsuran</label>
       <div class="col-lg-2">
            <input type="text" name="sisa_angsuran_badan" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">Jumlah angsuran / bln</label>
       <div class="col-lg-4">
            <input type="text" name="jml_angsuran_badan" class="form-control">
        </div>
    </div>
    </ol>
