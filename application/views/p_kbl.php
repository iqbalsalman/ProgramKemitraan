    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <form class="form-horizontal" id="form" action="<?php echo site_url('aprovel/insert'); ?>" method="post" enctype="multipart/form-data" >
      <?php foreach ($qry as $u) {  ?>
         <div class="form-group">
        <label class="col-lg-3 control-label">Nama Lengkap<font color="red">*</font></label>
		
        <div class="col-lg-4">
            <input type="text" name="nama" placeholder="Nama Lengkap" value="<?php echo $u->nm_pemilik ?>" class="form-control" id="nama">
             <div style="color: red;" id="invalid-nama" class="error_msg"></div>
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label">No KTP<font color="red">*</font></label>
    
        <div class="col-lg-3">
            <input type="text" name="nik" placeholder="No KTP" class="form-control" value="<?php echo $u->n_ktp ?>" id="nik">
             <div style="color: red;" id="invalid-nik" class="error_msg"></div>
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label">Alamat Perusahaan<font color="red">*</font></label>
    
        <div class="col-lg-4">
            <input type="text" name="alamat" placeholder="Alamat Perusahaan" class="form-control" value="<?php echo $u->alamat_usaha ?>" id="alamat">
             <div style="color: red;" id="invalid-nama" class="error_msg"></div>
        </div>
    </div>
     <div class="form-group">
        <label class="col-lg-3 control-label">Rekomendasi Dana<font color="red">*</font></label>
    
        <div class="col-lg-4">
            <input type="text" name="dana_cmb" placeholder="Rekomendasi Dana" class="form-control" value="<?php echo $u->perkiraan_dana?>" id="dana_cmb">
             <div style="color: red;" id="invalid-dana_cmb" class="error_msg"></div>
        </div>
    </div>
    <?php } ?>
