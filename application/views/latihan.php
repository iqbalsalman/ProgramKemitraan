  ...
  <aside class="main-sidebar">
    <!-- sidebar: style can be found in sidebar.less -->
     ...
     <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class=" fa  fa-book "></i> <span>have a new proposal</span>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."index.php/penilaian/penolakan"; ?>"><i class="fa fa-circle-o"></i>Data Penilaian CMB</a></li>
          ...
          <div class="box">
              ...
              <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th>Nama Lengkap</th>
                        <th>Nomer Telepon</th>
                        <th>Alamat Lengkap Dinas daerah</th>
            ...
            foreach ($query as $data) {
                ...
                ?>
                      ...
                      <td><?php echo $data->idproposal ?></td>
                      <td><?php echo $data->nlpcmb?></td>
                      <td><?php echo $data->nama_dinas ?></td>
                      <td><?php echo $data->tglmasuk?></td>
                <td>
                <center>
                <?php echo anchor('proposal_masuk/doprint/'.$data->idproposal,'Edit'); ?>
                                          </center>       
                </td>
                      </tr>
