       ...
       <?=$this->session->flashdata('pesan')?>
             ...
             <div class="alert alert-error">
              ...
              <div class="form-group">
                <div class="row">
                         <div class="col-xs-12">
            <?php echo anchor('registrasi/index/','<input type="button" class="btn btn-warning btn-block btn-flat" value="Registrasi">'); ?>
            <br/>
                       </div>
             <div class="col-xs-12">
            <?php echo anchor('login2/index/','<input type="button" class="btn btn-block btn-default btn-flat" value="Non Mitra">'); ?>
                       </div>
