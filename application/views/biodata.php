...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <form class="form-horizontal" id="form" action="<?php echo site_url('biodata/tambah'); ?>" method="post" enctype="multipart/form-data" >
         <ol type="1">
        ...
        <div class="col-lg-4">
             ...
             <input type="hidden" name="idproposal"  class="form-control" value="<?php echo $qry->idproposal ?>" >
            <input type="text"  name="nama" placeholder="Nama Lengkap (sesuai KTP)" class="form-control" id="nama">
     ...
     <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="file" name="proposalk" class="form-control" id="proposalk"  >
    ...
    <div class="form-group">
        ...
        <div class="col-lg-2">
            <input type="text" name="ta_lahir" placeholder="Tempat lahir" id="ta_lahir" class="form-control">
		...
		<div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  id="tgl_l" name="tgl_l" >
                </div>
    ...
    <div class="form-group">
	 ...
	 <div class="form-group">
        ...
        <div class="col-lg-2">
		 ...
		 <div class="col-lg-2">
            <input type="text" name="jml_anak" placeholder="Jumlah Anak" id="jml_anak" class="form-control" >
        </div>
    </div>
	<div class="form-group">
		...
		<div class="col-lg-3">
		<input type="text" name="nmkerja" placeholder="Nama Pekerjaan"  id="nmkerja"   class="form-control" >
...
<div style="color: red;" id="invalid-provinsi" class="error_msg"></div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-6">
            <select class='form-control' id='ktkb' name="ktkb">
<option value=''>--pilih--</option>
</select>
<div style="color: red;" id="invalid-ktkb" class="error_msg"></div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-6">
        <select class='form-control' id='kcamatan' name="kcamatan">
        <option value=''>--pilih--</option>
        </select>
  ...
  <div class="form-group">
        ...
        <div class="col-lg-6">
<select class='form-control' id='klurah' name="klurah">
<option value=''>--pilih--</option>
</select>
 <div style="color: red;" id="invalid-klurah" class="error_msg"></div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
             <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tlpr" id="tlpr" pattern="[0-9]{10}" title="Nomer Telepon Rumah harus berjumalah 10 digit">
                </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-2">
            <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="bsd" name="bsd">
                </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="pendidikan_f" class="form-control" id="pendidikan_f">
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="plt_k" class="form-control" id="plt_k">
        </div>
