            ...
            <?=$this->session->flashdata('pesan')?>
              <table id="example2" class="table table-bordered table-hover">
                ...
                ?> 
                      ...
                      <td><center><?php echo $cek->status ?></center></td>
                      <td><center><?php if($cek->nilai_asset > '4600000') 
                                    echo '<img width=32 height=32 src="http://localhost/pk/asset/img2/ceklis.png">'; else echo '<img width=32 height=32 src="http://localhost/pk/asset/img2/strips.png">'; ?></center></td>
                      ...
                      <td> <center><?php echo anchor('evaluasi/penNilai/'.$cek->idkegiatanusaha,'<input type="button" class="btn btn-info" value="Scores">'); ?></center></td>
                      </tr>
